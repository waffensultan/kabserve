        ...
        <main className="flex flex-col gap-8 h-full">
            ...
            <div className="w-full flex justify-center items-center gap-3 grow py-5">
                {["1", "2", "3", "...", "15"].map((elem: string) => (
                    <div
                        key={elem}
                        className={`${elem === "1" ? "bg-primary text-white" : "duration-150 hover:border-primary hover:bg-primary hover:white hover:text-white"} cursor-pointer  rounded-xl flex justify-center items-center w-10 h-10 border border-primary`}
                    >
