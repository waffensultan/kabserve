    ...
    return (
        <main className="flex flex-col gap-10 justify-center items-center py-15">
            ...
            <div
                ...
                md:grid-cols-2 md:grid-rows-2 lg:grid-cols-3 lg:grid-rows-3"
            >
                <article
                    onClick={() => setSelected("student")}
                    className="relative bg-white rounded-t-2xl flex flex-col justify-center items-center p-10 text-center w-75 cursor-pointer"
                >
                ...
                >
                    ...
                    <Typography variant="h3" className="md:hidden">
                        Browse as a visitor and discover what Kabserve has to
                        offer.
                    </Typography>
                    <Typography
                        variant="h2"
                    ...
                    <div
                        className={`absolute bottom-0 left-0 h-3 w-full bg-green-600 transition-all duration-300 ${
                            selected === "guest" ? "opacity-100" : "opacity-0"
                        }`}
                    />
                </article>
            </div>
